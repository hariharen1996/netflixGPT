      ...
      <div className="flex flex-col md:flex-row justify-between items-center mx-2 my-2">
        ...
        {user && (
          <div className="flex items-center">
            {search && (
              <select
                className="p-2 bg-gray-900 text-white text-xs sm:text-sm"
            ...
            <button
              className="bg-gray-900 p-2 hover:bg-[#e50914] hover:bg-opacity-70 m-2 text-white rounded-md text-xs sm:text-sm"
            ...
            <button
              ...
              className="bg-gray-900 p-2 text-xs sm:text-sm  hover:bg-[#e50914] hover:bg-opacity-70 text-white rounded-md"
            >
              Sign Out
            </button>
          </div>
